...
* Package version in repository should be increased immediately after new stable release on [crates.io](https://crates.io/crates/yoda) and before apply new changes
